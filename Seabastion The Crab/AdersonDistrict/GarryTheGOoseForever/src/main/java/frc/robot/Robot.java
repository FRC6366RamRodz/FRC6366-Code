...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    RobotContainer.ARM.setLight(true);
  ...
  public void autonomousPeriodic() {
    ...
    if(m_autoSelected == 1) { // 2 item
      ...
      if(autoTimer.get() <2.3) {
        ...
        RobotContainer.DriveTrain.autoTankDrive(0, 0);
      }
      ...
      if ( autoTimer.get() > 5.6) {
        RobotContainer.ARM.runArmSmartMotion(0, 0, false, false, 0, 0, false);
        RobotContainer.DriveTrain.autoTankDrive(-21.5, 21.5);
      } 
      if (autoTimer.get() >9 && autoTimer.get()<9.5 ) {
        RobotContainer.ARM.runArmSmartMotion(4, 13, true, false, 0.35, -0.35, false);
      RobotContainer.DriveTrain.resetDriveEncoder();
      RobotContainer.DriveTrain.autoTankDrive(0, 0);
        // Put custom auto code here
      } if (autoTimer.get() >9.5) {
        RobotContainer.ARM.runArmSmartMotion(4, 13, true, false, 0.35, -0.35, false);
        RobotContainer.DriveTrain.autoTankDrive(85, 85);
      }
      }
      ...
      if(autoTimer.get()>4.3&&autoTimer.get()<8.5) {
        RobotContainer.ARM.runArmSmartMotion(0, 0, false, false, 0, 0, false);
        RobotContainer.DriveTrain.autoTankDrive(-83, -83); // backup past line.
      } else if (autoTimer.get()>8.5 && autoTimer.get()<12){
        RobotContainer.ARM.runArmSmartMotion(0, 0, false, false, 0, 0, false);
        RobotContainer.DriveTrain.autoTankDrive(-37, -37); // pull forward and balance on ramp.
      } if (autoTimer.get()>12) {
        RobotContainer.ARM.runArmSmartMotion(10, 0, false, false, 0, 0, false);
        RobotContainer.DriveTrain.autoTankDrive(-41.4, -41.4);
      }
...
RobotContainer.ARM.setIndicators(cone, cube, scoreMode);
//arm controller
