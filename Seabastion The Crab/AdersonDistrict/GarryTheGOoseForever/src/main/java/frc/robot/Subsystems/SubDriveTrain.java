...
// teleop tank drive
    public void runTankDrive (double leftY, double rightX, boolean limelightButton) {
        LEFT_FRONT_MOTOR.setClosedLoopRampRate(1.65);
        RIGHT_FRONT_MOTOR.setClosedLoopRampRate(1.65);
...
//teleop stinger drive
    public void runStingerDrive (double leftY, double leftX, double rightX, double triggerSteer){
        ...
        LEFT_FRONT_MOTOR.setClosedLoopRampRate(0.5);
        RIGHT_FRONT_MOTOR.setClosedLoopRampRate(0.5);
        STINGER_MOTOR.setClosedLoopRampRate(0.5);
        STRAFE_MOTOR.setClosedLoopRampRate(4.5);
        //set Solenoid       
