    ...
    switch (m_autoSelected) {
      case kRamp:
        if (autoTimer.get() < 1.3 ) {
          ...
          RobotContainer.ARM.runArmSmartMotion(40, 4, false);
          ...
          RobotContainer.DriveTrain.runTankAuto(0, 0, false);
          RobotContainer.ARM.runArmSmartMotion(40, 4, false);
          RobotContainer.CLAW.runClaw(-0.2, 0.2, true, false, false, false);
      ...
      if (autoTimer.get() < 1.3 ) {
        ...
        RobotContainer.DriveTrain.runTankAuto(-69, 69, false);
        RobotContainer.ARM.runArmSmartMotion(0, 0, false);
        RobotContainer.CLAW.runClaw(0, 0, false, false, false, false); 
      } else if (autoTimer.get() < 7.8) {
        RobotContainer.DriveTrain.runGyroDrive(true, 179);
        RobotContainer.ARM.runArmSmartMotion(0, 0, false);
        RobotContainer.CLAW.runClaw(0, 0, false, false, false, false); 
      } else if (autoTimer.get() < 8) {
        RobotContainer.DriveTrain.zeroDrive();
      }else if (autoTimer.get() < 10) {
        RobotContainer.DriveTrain.runTankAuto(25, -25, false);
        RobotContainer.ARM.runArmSmartMotion(5, 8, false);
        RobotContainer.CLAW.runClaw(0.3, -0.3, true, false, false, false); 
      } else if (autoTimer.get() < 11.8) {
        RobotContainer.DriveTrain.runGyroDrive(true, -1);
        RobotContainer.ARM.runArmSmartMotion(0, 0, false);
        RobotContainer.CLAW.runClaw(0, 0, false, false, false, false);
      } else if (autoTimer.get() <11.85) {
        RobotContainer.DriveTrain.zeroDrive();
      } else if (autoTimer.get() < 14.30) {
        RobotContainer.DriveTrain.runTankAuto(90, -90, false);
        RobotContainer.ARM.runArmSmartMotion(0, 0, false);
        RobotContainer.CLAW.runClaw(0, 0, true, false, false, false); 
      } else {
        RobotContainer.DriveTrain.runTankAuto(90, -90, false);
        RobotContainer.ARM.runArmSmartMotion(0, 0, false);
        RobotContainer.CLAW.runClaw(-0.4, 0.4, true, false, false, false); 
      }
