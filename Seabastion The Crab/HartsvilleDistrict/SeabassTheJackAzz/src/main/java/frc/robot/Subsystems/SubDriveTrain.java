...
// teleop drive 
    public void runDriveTrain (double left, double right, double strafe, double stinger, boolean strafeButterfly, boolean stingerButterfly, double tankAcc, double strafeAcc, double stingerAcc, boolean limelightButton, double leftY, double leftX) {
        double Left, Right, Strafe, Stinger;
        double targetX;
        ...
        //set drive motors
        LEFT_FRONT_PIDCONTROLLER.setReference(Left*Constants.AR_SET.maxRPM, CANSparkMax.ControlType.kVelocity);
        RIGHT_FRONT_PIDCONTROLLER.setReference(Right*-Constants.AR_SET.maxRPM, CANSparkMax.ControlType.kVelocity);
        STRAFE_PIDCONTROLLER.setReference(-Strafe*10.0, CANSparkMax.ControlType.kVoltage);
        STINGER_PIDCONTROLLER.setReference(Stinger*10.0, CANSparkMax.ControlType.kVoltage);
        //butturfly control
