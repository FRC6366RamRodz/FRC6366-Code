...
//toggles
  ...
  public void teleopPeriodic() {
      //variables
      double ArmPosition1, elbowPosition1, ArmPositon2, elbowPosition2, ArmPositionA; //1 = clean input //2 = 1 stage of proccesing //3 = this controll is overcomplicated
      boolean Home;
      ...
      //drivetrain setter.
      RobotContainer.DriveTrain.runDriveTrain(left2, right2, strafe2, stinger2, strafebutter, stingerbutter, Tacc, Sacc, StAcc,IO.getYbutton(), IO.getLeftY(), IO.getLeftX());
