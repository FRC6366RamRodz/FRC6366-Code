...
public class Constants {
    ...
    public static class DT_Set{
        ...
        public static final double maxVel = 6500; // rpm
        public static final double maxAcc = 3600;
    ...
    public static class AR_SET {
        ...
        public static final double reachConeElbow = 16;
        ...
        public static final double stationArm = 68;
        public static final double stationElbow = 17;
