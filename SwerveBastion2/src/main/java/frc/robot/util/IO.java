...
public class IO {
  private static final XboxController driver =
      new XboxController(0); // reference 360 for controll names
  ...
  // Operator
  private static final XboxController operator =
      new XboxController(1); // reference 360 for controll names
