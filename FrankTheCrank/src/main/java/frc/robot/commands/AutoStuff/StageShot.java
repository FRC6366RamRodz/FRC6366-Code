...
public class StageShot extends Command {
  ...
  public void execute() {
    if (RobotContainer.shooter.LaunchPermision() == 1) {
      shotTime.start();
      RobotContainer.shooter.advancedShoot(false, false, false, true, false, false, false, true, 0, false);
    } else {
      RobotContainer.shooter.advancedShoot(false, false, false, true, false, false, false, false, 0, false);
    }
  }
